...
namespace DataAccess
{
    public class AccesoDatos
    {
        ...
        static AccesoDatos()
        {
            CadenaConexion = @"data source=SERVKEY-XPS\SQLSERVER;initial catalog=DBLEDEER;persist security info=True;user id=coral;password=a1s2d3";// ConfigurationManager.AppSettings["Conecta"];
        }
