...
\begin{figure}[h!]
\centering
\includegraphics[scale=0.70]{images/ModelDefinitionByWebPlatformProcess_ESP}
\caption{Proceso de definici\'on de modelo de dominio y reglas de comportamiento.}
\label{arch:domdef}
\end{figure}
