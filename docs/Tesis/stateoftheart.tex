...
En otro estudio realizado por Skillen \cite{Skillen201497} se habla de un mecanismo de personalizaci\'on basado en reglas, en el que se perfila a los usuarios por medio de un m\'etodo ontol\'ogico especificando elementos como la ubicaci\'on, preferencias multimedia del usuario, objetos de asistencia que son los involucrados en la interacci'on, actividades, medios de entrega de informaci\'on, condici\'ones de salud, escala de calidad multimedia y formato de interfaz gr\'afica.
