...
namespace WebApplication1
{
    public partial class Tareas : System.Web.UI.Page
    {
        ...
        protected void crearFormulario(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                for (int i = 0; i < noCampos; i++)
                    addCampos(i);
                fillDropDown(categoria,"Categorias");
                fillDropDown(objeto, "Objetos");
                fillDropDown(objetivo, "Objetivos");
                fillDropDown(rolactor, "RolesDeActor");
                fillDropDown(rolobjeto, "RolesDeObjeto");
            }
        }
        ...
        protected void registrar(Object sender, EventArgs e)
        {
            ...
            vals.Add("F_ID_OB", objeto.SelectedValue);
            vals.Add("F_ID_OBJETIVO", objetivo.SelectedValue);
            vals.Add("F_ID_RO", rolobjeto.SelectedValue);
            vals.Add("F_ID_RA", rolactor.SelectedValue);
            vals.Add("F_ID_CA", categoria.SelectedValue);
            vals.Add("nombre", nombre);
            vals.Add("ID_Caso", Session["idcaso"].ToString());
            if (dbcontroller.addRecord("Tareas", vals))
